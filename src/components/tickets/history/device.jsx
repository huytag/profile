...
const DeviceTicketHistoryComponent = ({
  itemId,
  inTab = false,
  limit = null,
}) => {
  ...
  const fetchTicketHistory = async () => {
    setLoading(true);
    await list(`${ITEMS}/${itemId}/ticket-histories`, {
      limit,
      page,
    })
      .then((response) => {
  ...
  return (
    ...
    >
      <div>
        ...
        <hr className="block h-[2px] bg-[#ccc] mt-3" />
      </div>
...
export default DeviceTicketHistoryComponent;
