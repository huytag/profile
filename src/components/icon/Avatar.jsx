...
const IconAvatar = ({ className = "w-6" }) => {
  return (
    <svg
    ...
    >
      ...
      <g clipPath="url(#SVGID_2_)">
        <path
          fill="#316CFF"
          d="M13 64c0-9.3 8.5-17 19-17 10.4 0 19 7.7 19 17"
        ></path>
      </g>
      <g clipPath="url(#SVGID_2_)">
        <circle cx="32" cy="50" r="6" fill="#FFF"></circle>
      </g>
      <g clipPath="url(#SVGID_2_)">
        <path
          fill="#F7BE8F"
      ...
      <g clipPath="url(#SVGID_2_)">
        <path fill="#F7BE8F" d="M33 39c0 .6-.4 1-1 1s-1-.4-1-1h2z"></path>
      </g>
      <g clipPath="url(#SVGID_2_)">
        <path
          fill="#F4B28E"
