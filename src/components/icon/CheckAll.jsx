...
const IconCheckAll = ({ className = "w-6" }) => {
  return (
    <svg
      viewBox="0 0 128 128"
    ...
    >
      ...
      <path d="M25.5,113a2,2,0,0,1-1.41-.58L8.59,96.9a2,2,0,0,1,2.82-2.82L25.5,108.17,44.59,89.08a2,2,0,0,1,2.82,2.83l-20.49,20.5A2,2,0,0,1,25.5,113Z" />
